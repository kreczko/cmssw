#ifndef L1TJetMetAnalyzer_Offline_H
#define L1TJetMetAnalyzer_Offline_H
...
class L1TJetMetAnalyzer_Offline: public DQMEDAnalyzer {

public:

	L1TJetMetAnalyzer_Offline(const edm::ParameterSet& ps);
	virtual ~L1TJetMetAnalyzer_Offline();
...
private:
	...
	// jet turn-ons
	MonitorElement* h_turnOnJet_HB_pass_;
	MonitorElement* h_turnOnJet_HE_pass_;
	MonitorElement* h_turnOnJet_HF_pass_;
	MonitorElement* h_turnOnJet_HB_HE_pass_;

	MonitorElement* h_turnOnJet_HB_total_;
	MonitorElement* h_turnOnJet_HE_total_;
	MonitorElement* h_turnOnJet_HF_total_;
	MonitorElement* h_turnOnJet_HB_HE_total_;
